classdef Metadata
    ...
    properties
        ...
        chromAbFlag         %set to true if acquisition was using the dragonfly 40x water objective
    end
...
%                 end
                ...
                if manualMeta.plateLayoutNames
                    ...
                    if isempty(this.posPerCondition)
%                         this.posPerCondition = this.nPositions / this.nWells;
                        this.posPerCondition = repmat(this.nPositions / this.nWells, 1, this.nWells);
                    end
                    if this.nPositions ~= sum(this.posPerCondition)% this.posPerCondition*this.nWells
        ...
        function this = read(this, filename)
            ...
            if strcmp(extension,'.ims') && abs(this.xres - 0.3015) < 0.01
                this.chromAbFlag = true;
            else
                this.chromAbFlag = false;
            end
        end
